<template>
  <svg :width="size" :height="size" viewBox="0 0 55.2 38.4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="enable-background:new 0 0 55.2 38.4" xml:space="preserve">
    <g>
